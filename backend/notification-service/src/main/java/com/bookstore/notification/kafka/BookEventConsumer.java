 ...
 * Listens to book-events topic and sends notifications
 */
@Component
...
public class BookEventConsumer {
    ...
    private void handleBookCreated(BookEvent event) {
        ...
        notificationService.sendBookCreatedNotification(event);
    }
    ...
    private void handleBookUpdated(BookEvent event) {
        ...
        notificationService.sendBookUpdatedNotification(event);
    }
